...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv')?.addEventListener('click', () => {
            ...
            XLSX.utils.book_append_sheet(workbook, worksheet, 'Pending SO');
            XLSX.writeFile(workbook, 'pending-sales-orders.xlsx');
        });
        ...
        document.getElementById('exportExcel')?.addEventListener('click', () => {
            ...
            doc.text('Pending Sales Order Report', 40, 30);
            doc.autoTable({
                columns: exportCols,
                body: rows,
                startY: 50,
            ...
            doc.save('pending-sales-orders.pdf');
        });
    });
</script>
@endpush