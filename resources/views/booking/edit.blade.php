...
<div class="container-fluid">
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <h5 class="d-inline-block mb-0">Edit Booking</h5>
            ...
            <div class="col-lg-4 text-end">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-end">
                        <li class="breadcrumb-item"><a href="{{ backpack_url('dashboard') }}"><i class="ik ik-home"></i> Home</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <form id="bookingForm" method="POST" action="{{ backpack_url('booking/'.$entry->id) }}" enctype="multipart/form-data" class="forms-sample">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-2 form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $entry->b_type == 'Active' ? 'Actual' : 'Dummy' }}" readonly>
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                <input type="text" class="form-control"
                                       value="{{ $entry->receipt_date ? \Carbon\Carbon::parse($entry->receipt_date)->format('d-M-Y') : '' }}" readonly>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <select name="care_of" id="care_of" class="form-control select2" required>
                                    ...
                                    <option value="2" {{ $entry->care_of_type == 2 ? 'selected' : '' }}>Daughter of</option>
                                    <option value="3" {{ $entry->care_of_type == 3 ? 'selected' : '' }}>Married to</option>
                                    <option value="4" {{ $entry->care_of_type == 4 ? 'selected' : '' }}>Guardian Name</option>
                                    <option value="5" id="ownedByOption" {{ $entry->care_of_type == 5 ? 'selected' : '' }}>Owned By</option>
                                </select>
                            </div>

                            <div class="col-sm-3 form-group">
                                <label id="careofnamelabel">
                                    {{ $entry->b_cat === 'Firm' ? 'Owner Name' : 'Care Of Name' }} <span class="required-mark">*</span>
                                </label>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <select name="gender" id="gender" class="form-control select2" required>
                                    ...
                                    <option value="Transgender" {{ $entry->gender == 'Transgender' ? 'selected' : '' }}>Transgender</option>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <select name="occupation" id="occupation" class="form-control select2" required>
                                    <option value="">Please Select...</option>
                                    <option value="Agriculture" {{ $entry->occ == 'Agriculture' ? 'selected' : '' }}>Agriculture</option>
                                    <option value="Business" {{ $entry->occ == 'Business' ? 'selected' : '' }}>Business</option>
                                    <option value="Salaried (Govt.)" {{ $entry->occ == 'Salaried (Govt.)' ? 'selected' : '' }}>Salaried (Govt.)</option>
                                    <option value="Salaried (Pvt.)" {{ $entry->occ == 'Salaried (Pvt.)' ? 'selected' : '' }}>Salaried (Pvt.)</option>
                                    <option value="Self Employed (Professional)" {{ $entry->occ == 'Self Employed (Professional)' ? 'selected' : '' }}>Self Employed (Professional)</option>
                                    <option value="Pensioner" {{ $entry->occ == 'Pensioner' ? 'selected' : '' }}>Pensioner</option>
                            ...
                            <div class="col-sm-3 form-group" id="gstn-group">
                                <label for="gstn">GSTN 
                                    <span class="required-mark" id="gstn-required" style="display: {{ ($entry->gstn == '0' || $entry->gstn === null) ? 'none' : 'inline' }};">*</span>
                                </label>
                                <input type="text" name="gstn" id="gstn" class="form-control uppercase" 
                                       ...
                                       {{ ($entry->gstn == '0' || $entry->gstn === null) ? 'disabled' : '' }}>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <input type="text" name="customer_age" id="customer_age" class="form-control" 
                                       value="{{ $entry->c_dob ? \Carbon\Carbon::parse($entry->c_dob)->age : '' }}" readonly>
                            </div>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <select name="location_id" id="location" class="form-control select2" required>
                                    ...
                                    @foreach($data['locations'] as $location)
                                        <option value="{{ $location['id'] }}" {{ $entry->location_id == $location['id'] ? 'selected' : '' }}>
                            ...
                            <div class="col-sm-3 form-group" id="location_other_group" style="{{ $entry->location_id == 0 ? '' : 'display:none;' }}">
                                <label for="location_other">Other Location</label>
                                <input type="text" name="location_other" id="location_other" class="form-control uppercase" 
                                       value="{{ $entry->location_other }}" {{ $entry->location_id == 0 ? '' : 'disabled' }}>
                            </div>
                            ...
                            <div class="col-sm-12 mt-4">
                                ...
                                <div class="row" id="referred_by_fields" style="{{ $entry->r_name ? '' : 'display:none;' }}">
                                    <div class="col-sm-3 form-group">
                                        <label for="ref_customer_name">Customer Name <span class="required-mark" style="display: none;">*</span></label>
                                        <input type="text" name="ref_customer_name" id="ref_customer_name" class="form-control uppercase" 
                                               value="{{ $entry->r_name ?? '' }}">
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label for="ref_mobile_no">Mobile No. <span class="required-mark" style="display: none;">*</span></label>
                                        <input type="text" name="ref_mobile_no" id="ref_mobile_no" class="form-control" 
                                               value="{{ $entry->r_mobile ?? '' }}">
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label for="ref_existing_model">Existing Model <span class="required-mark" style="display: none;">*</span></label>
                                        <input type="text" name="ref_existing_model" id="ref_existing_model" class="form-control uppercase" 
                                               value="{{ $entry->r_model ?? '' }}">
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label for="ref_variant">Variant <span class="required-mark" style="display: none;">*</span></label>
                                        <input type="text" name="ref_variant" id="ref_variant" class="form-control uppercase" 
                                               value="{{ $entry->r_variant ?? '' }}">
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label for="ref_chassis_reg_no">Chassis / Regn. No. <span class="required-mark" style="display: none;">*</span></label>
                                        <input type="text" name="ref_chassis_reg_no" id="ref_chassis_reg_no" class="form-control uppercase" 
                                               value="{{ $entry->r_chassis ?? '' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-2 form-group">
                                ...
                                <select name="buyer_type" id="buyer_type" class="form-control select2" required>
                                    <option value="First time Buyer" {{ $entry->buyer_type == 'First time Buyer' ? 'selected' : '' }}>First time Buyer</option>
                                    <option value="Additional Buy" {{ $entry->buyer_type == 'Additional Buy' ? 'selected' : '' }}>Additional Buy</option>
                                    <option value="Exchange Buy" {{ $entry->buyer_type == 'Exchange Buy' ? 'selected' : '' }}>Exchange Buy</option>
                                    <option value="Scrappage" {{ $entry->buyer_type == 'Scrappage' ? 'selected' : '' }}>Scrappage</option>
                                </select>
                            </div>
                        
                            <div class="col-sm-2 form-group">
                                <label for="enum_master1">Brand (Make 1) <span class="required-mark" style="display: none;">*</span></label>
                                <select name="enum_master1" id="enum_master1" class="form-control select2" disabled>
                                    <option value="">Please Select...</option>
                                    @foreach ($data['enum_master'] as $enum)
                                        <option value="{{ $enum->id }}" {{ $entry->exist_oem1 == $enum->id ? 'selected' : '' }}>
                                            {{ $enum->value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-3 form-group">
                                <label for="vehicle_details">Model & Variant 1 <span class="required-mark" style="display: none;">*</span></label>
                                <input type="text" name="vehicle_details" id="vehicle_details" class="form-control uppercase" 
                                       value="{{ $entry->vh1_detail }}" disabled>
                            </div>
                        
                            <div class="col-sm-2 form-group">
                                <label for="enum_master2">Brand (Make 2) <span class="required-mark" style="display: none;">*</span></label>
                                <select name="enum_master2" id="enum_master2" class="form-control select2" disabled>
                                    <option value="">Please Select...</option>
                                    @foreach ($data['enum_master'] as $enum)
                                        <option value="{{ $enum->id }}" {{ $entry->exist_oem2 == $enum->id ? 'selected' : '' }}>
                                            {{ $enum->value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-3 form-group">
                                <label for="vehicle_details2">Model & Variant 2 <span class="required-mark" style="display: none;">*</span></label>
                                <input type="text" name="vehicle_details2" id="vehicle_details2" class="form-control uppercase" 
                                       value="{{ $entry->vh2_detail }}" disabled>
                            </div>
                        
                            <div class="col-sm-4 form-group">
                                <label for="registration_no">Vehicle Registration No. <span class="required-mark" style="display: none;">*</span></label>
                                <input type="text" name="registration_no" id="registration_no" class="form-control uppercase" 
                                       value="{{ $entry->registration_no }}" disabled>
                            </div>
                        
                            <div class="col-sm-4 form-group">
                                <label for="manufacturing_year">Vehicle Manufacturing Year <span class="required-mark" style="display: none;">*</span></label>
                                <input type="number" name="manufacturing_year" id="manufacturing_year" class="form-control" 
                                       value="{{ $entry->make_year }}" disabled>
                            </div>
                        
                            <div class="col-sm-4 form-group">
                                <label for="odometer_reading">Vehicle Odometer Reading <span class="required-mark" style="display: none;">*</span></label>
                                <input type="text" name="odometer_reading" id="odometer_reading" class="form-control" 
                                       value="{{ $entry->odo_reading }}" disabled>
                            </div>
                        
                            <div class="col-sm-3 form-group">
                                <label for="expected_price">Used Vehicle Expected Price <span class="required-mark" style="display: none;">*</span></label>
                                <input type="number" name="expected_price" id="expected_price" class="form-control" 
                                       value="{{ $entry->expected_price }}" disabled>
                            </div>
                        
                            <div class="col-sm-3 form-group">
                                <label for="offered_price">Used Vehicle Offered Price <span class="required-mark" style="display: none;">*</span></label>
                                <input type="number" name="offered_price" id="offered_price" class="form-control" 
                                       value="{{ $entry->offered_price }}" disabled>
                            </div>
                        
                            <div class="col-sm-3 form-group">
                                <label for="exchange_bonus">New Vehicle Exchange Bonus <span class="required-mark" style="display: none;">*</span></label>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <input type="text" name="difference" id="difference" class="form-control" 
                                       value="{{ $entry->expected_price - ($entry->offered_price + $entry->exchange_bonus) }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <input type="text" name="seating" id="seating" class="form-control" value="{{ $entry->seating }}" readonly>
                            </div>

                            <!-- Accessories -->
                            <div class="col-sm-4 form-group">
                                <label for="accessories">Select Accessories</label>
                                <select name="accessories[]" id="accessories" class="form-control select2" multiple disabled>
                                    <!-- AJAX से fill होगा -->
                                </select>
                            </div>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <input type="text" name="apack_amount" id="apack_amount" class="form-control" value="{{ $entry->apack_amount }}" readonly>
                            </div>
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <select name="booking_mode" id="booking_mode" class="form-control select2" required>
                                    <option value="">Please Select...</option>
                                    <option value="Dealer" {{ $entry->b_mode == 'Dealer' ? 'selected' : '' }}>Dealer</option>
                                    <option value="Online" {{ $entry->b_mode == 'Online' ? 'selected' : '' }}>Online</option>
                                </select>
                            </div>
                        
                            <!-- Online Booking Reference No. -->
                            <div class="col-sm-3 form-group" id="refrence_no_group" style="display: {{ $entry->b_mode == 'Online' ? 'block' : 'none' }};">
                                <label for="refrence_no">Online Book Ref No. <span class="required-mark">*</span></label>
                                <input type="text" name="refrence_no" id="refrence_no" class="form-control uppercase" 
                                       value="{{ $entry->online_bk_ref_no }}" {{ $entry->b_mode == 'Online' ? 'required' : 'disabled' }}>
                            </div>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <select name="booking_source" id="booking_source" class="form-control select2" required>
                                    <option value="">Please Select...</option>
                                    <option value="Dealer" {{ $entry->b_source == 'Dealer' ? 'selected' : '' }}>Dealer Sourcing</option>
                                    <option value="DSA" {{ $entry->b_source == 'DSA' ? 'selected' : '' }}>DSA</option>
                                </select>
                            </div>
                        
                            <!-- DSA Details -->
                            <div class="col-sm-3 form-group" id="dsa_details_group" style="display: {{ $entry->b_source == 'DSA' ? 'block' : 'none' }};">
                                <label for="dsa_details">Select DSA <span class="required-mark">*</span></label>
                                <select name="dsa_details" id="dsa_details" class="form-control select2" {{ $entry->b_source == 'DSA' ? 'required' : 'disabled' }}>
                                    <option value="">Please Select...</option>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <select name="saleconsultant" id="saleconsultant" class="form-control select2" required>
                                    ...
                                    @foreach($data['saleconsultants'] as $consultant)
                                        <option value="{{ $consultant->id }}" {{ $entry->consultant == $consultant->id ? 'selected' : '' }}>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <div class="mt-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="delivery_type" id="delivery_expected" value="Expected"
                                               {{ old('delivery_type', $entry->del_type) == 'Expected' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="delivery_expected">Expected</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="delivery_type" id="delivery_confirmed" value="Confirmed"
                                               {{ old('delivery_type', $entry->del_type) == 'Confirmed' ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-3 form-group">
                                <label for="expected_del_date">Delivery Date <span class="required-mark">*</span></label>
                                <input type="text" name="expected_del_date" id="expected_del_date" class="form-control flatpickr"
                                       value="{{ $entry->del_date ? \Carbon\Carbon::parse($entry->del_date)->format('d-M-Y') : '' }}"
                                       placeholder="dd-mmm-yyyy" required>
                                <input type="hidden" name="expected_del_date_actual" id="hidden_expected_del_date" value="{{ $entry->del_date }}">
                            </div>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <select name="fin_mode" id="fin_mode" class="form-control select2" required>
                                    <option value="">Please Select...</option>
                                    <option value="In-house" {{ $entry->fin_mode == 'In-house' ? 'selected' : '' }}>In-house</option>
                                    <option value="Customer Self" {{ $entry->fin_mode == 'Customer_self' ? 'selected' : '' }}>Customer Self</option>
                                    <option value="Cash" {{ $entry->fin_mode == 'Cash' ? 'selected' : '' }}>Cash</option>
                                    <option value="Yet To Decide" {{ $entry->fin_mode == 'Yet To Decide' ? 'selected' : '' }}>Yet To Decide</option>
                                </select>
                            </div>
                        
                            <!-- Financier -->
                            <div class="col-sm-3 form-group" id="financier_box" style="display: {{ $entry->fin_mode == 'In-house' ? 'block' : 'none' }};">
                                <label for="financier">Financier <span class="required-mark">*</span></label>
                                <select name="financier" id="financier" class="form-control select2" {{ $entry->fin_mode == 'In-house' ? 'required' : 'disabled' }}>
                                    <option value="">Select Financier</option>
                                    @foreach($data['financiers'] as $fin)
                                        <option value="{{ $fin->id }}" data-short_name="{{ $fin->short_name }}"
                                                {{ $entry->financier == $fin->id ? 'selected' : '' }}>
                                            {{ $fin->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-3 form-group" id="financier_short_name_box" style="display: {{ $entry->fin_mode == 'In-house' ? 'block' : 'none' }};">
                            ...
                            <!-- Loan Status -->
                            <div class="col-sm-3 form-group" id="loan_status_box" style="display: {{ $entry->fin_mode == 'In-house' ? 'block' : 'none' }};">
                                <label for="loan_status">Loan File Status <span class="required-mark">*</span></label>
                                <select name="loan_status" id="loan_status" class="form-control select2" {{ $entry->fin_mode == 'In-house' ? 'required' : 'disabled' }}>
                                    <option value="">Please Select...</option>
                                    <option value="Pending" {{ $entry->loan_status == 'Pending' ? 'selected' : '' }}>Pending</option>
                                    <option value="Complete" {{ $entry->loan_status == 'Complete' ? 'selected' : '' }}>Complete</option>
                                </select>
                            </div>
                        ...
                        @endphp
                        <div class="row mt-3" id="make_order_container" style="display: {{ $showMakeOrder ? 'block' : 'none' }};">
                            <div class="col-sm-12">
                                <div class="form-check">
                                    <input type="checkbox" name="make_order" id="make_order" value="1" class="form-check-input"
                                           {{ $entry->order == 1 ? 'checked' : '' }}>
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 form-group">
                                ...
                                <textarea name="details" id="details" class="form-control" rows="3" required>{{ $entry->details }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    // GST Unregistered Toggle
    $('#gst_unregistered').on('change', function() {
        const isUnchecked = !this.checked;
        $('#gstn').prop('disabled', !isUnchecked).prop('required', isUnchecked);
        $('#gstn-required').toggle(isUnchecked);
        if (!isUnchecked) $('#gstn').val('');
    });

    $('#referred_by_checkbox').on('change', function() {
        $('#referred_by_fields').toggle(this.checked);
        const isShown = this.checked;
        $('#referred_by_fields .required-mark').toggle(isShown);
        $('#referred_by_fields input').prop('required', isShown);
        if (!isShown) $('#referred_by_fields input').val('');
    }).trigger('change');

    $('#customer_dob').on('change', function() {
        const dob = $(this).val();
        if (dob) {
            const age = moment().diff(moment(dob, 'DD-MMM-YYYY'), 'years');
            $('#customer_age').val(age);
            $('#hidden_customer_dob').val(moment(dob, 'DD-MMM-YYYY').format('YYYY-MM-DD'));
        }
    });

    flatpickr('#customer_dob', { dateFormat: "d-M-Y", allowInput: true });

    $('#branch').on('change', function() {
        const branchId = this.value;
        if (!branchId) return;
        $.get('{{ backpack_url("branchlocations") }}/' + branchId, function(data) {
            const $loc = $('#location');
            $loc.html('<option value="">Please Select...</option>');
            $.each(data, function(_, item) {
                $loc.append(`<option value="${item.id}">${item.name}</option>`);
            });
            $loc.append('<option value="0">OTHER</option>');
            $loc.prop('disabled', false);
            $loc.val('{{ $entry->location_id }}').trigger('change');
        });
    });
    // Location change
    $('#location').on('change', function() {
        const isOther = this.value == '0';
        $('#location_other_group').toggle(isOther);
        $('#location_other').prop('disabled', !isOther).prop('required', isOther);
        if (!isOther) $('#location_other').val('');
    });
</script>
<script>
$(document).ready(function() {
