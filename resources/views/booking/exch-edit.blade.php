    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- Detailed Read-only Booking & Customer Info (Merged from provided content) -->
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" class="form-control is-valid" value="{{ $booking->b_type }}"
                                    readonly>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="form-control is-valid" value="{{ $booking->care_of }}"
                                    readonly>
                            </div>
                            <div class="col-sm-3">
                                <label class="form-label">Contact No. <span class="text-red">*</span></label>
                                <input type="text" class="form-control is-valid" value="{{ $booking->mobile }}"
                                    readonly>
                            </div>
                            <div class="col-sm-4">
                                <label class="form-label">Alternate Contact No.</label>
                                <input type="text" class="form-control is-valid"
                                    value="{{ $booking->alt_mobile ?? 'N/A' }}" readonly>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="form-control is-valid"
                                    value="{{ \Carbon\Carbon::parse($booking->c_dob)->format('d-M-Y') ?? 'N/A' }}"
                                    readonly>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="form-control is-valid" value="{{ $booking->variant }}"
                                    readonly>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" class="form-control is-valid" value="{{ $booking->seating }}"
                                    readonly>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="form-control is-valid" value="{{ $booking->del_type }}"
                                    readonly>
                            </div>
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="form-control is-valid"
                                    value="{{ \Carbon\Carbon::parse($booking->receipt_date)->format('d-M-Y') }}"
                                    readonly>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="form-control is-valid" value="{{ $booking->fin_mode }}"
                                    readonly>
                            </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="form-control is-valid" value="{{ $booking->inv_no }}"
                                    readonly>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <label class="form-label">Sales Force Booking Number</label>
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" class="form-control is-valid"
                                    value="{{ $booking->otf_date ?? 'N/A' }}" readonly>
                            </div>
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-12 table-responsive">
                                <label class="form-label">{{ __('Booking Journey(Remarks)') }}</label>
                ...
                <!-- Editable Exchange Form (Merged/Updated with additional fields) -->
                <form id="purchaseTypeForm" class="forms-sample" method="POST"
                    ...
                    <div class="card shadow-sm">
                        <div class="card-header bg-white">
                            <h5 class="mb-0">{{ __('Purchase Type Details') }}</h5>
                        </div>
                        <div class="card-body">
