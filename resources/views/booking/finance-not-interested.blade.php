...
<script>
    ...
    document.getElementById('status_filter')?.addEventListener('change', e => {
        ...
        window.location.href = `{{ route('finance.not-interested') }}?status_filter=${value}`;
    });
    ...
    document.getElementById('exportCsv')?.addEventListener('click', () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, 'Not Interested');
        XLSX.writeFile(workbook, 'not-interested-bookings.xlsx');
    });
    ...
    document.getElementById('exportPdf')?.addEventListener('click', () => {
        ...
        doc.save('not-interested-bookings.pdf');
    });
});
</script>
@endpush