            ...
            <div class="card-header bg-gradient-warning
                ...
                <div class="d-flex align-items-center gap-2
                    ...
                    <select id="status_filter" class="form-control form-select w-100 w-md-auto"
                        ...
                        <option value="" {{ request('status_filter')=='' ? 'selected' : '' }}>Pending</option>
                        <option value="4" {{ request('status_filter')==4 ? 'selected' : '' }}>Accepted</option>
                        <option value="5" {{ request('status_filter')==5 ? 'selected' : '' }}>Rejected</option>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv')?.addEventListener('click', () => {
            ...
            XLSX.writeFile(workbook, 'pending-dms-' + new Date().toISOString().slice(0,10) + '.xlsx');
        });
