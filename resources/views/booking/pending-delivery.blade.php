            ...
            <div class="card-body p-0 bg-light">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 p-3 border-bottom bg-white">
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        <input type="text" id="quickFilter" class="form-control" style="width: 360px; min-width: 260px;" placeholder="Quick search in all columns...">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv')?.addEventListener('click', () => {
            ...
            XLSX.utils.book_append_sheet(workbook, worksheet, 'Pending Deliveries');
            XLSX.writeFile(workbook, 'pending-deliveries-' + new Date().toISOString().slice(0,10) + '.xlsx');
        });
        ...
        document.getElementById('exportExcel')?.addEventListener('click', () => {
            ...
            doc.text('Pending Deliveries Report', 40, 30);
            doc.autoTable({
                columns: exportColumns,
                body: rows,
                startY: 50,
                styles: { fontSize: 8 },
                headStyles: { fillColor: [40, 167, 69] }, // primary/green theme
            });

            doc.save('pending-deliveries.pdf');
        });
    });
</script>
@endpush
