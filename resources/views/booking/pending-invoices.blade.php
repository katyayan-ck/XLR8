...
<style>
    ...
    /* Pinned columns visual distinction */
...
<script>
    ...
    // ────────────────────────────────────────────────
    // Default visible fields → only those marked Y
    // ────────────────────────────────────────────────
    const DEFAULT_VISIBLE_FIELDS = [
        ...
        'booking_date',
        'dealer_inv_no',               // Dealer Invoice No.
        'dealer_inv_date',      // Dealer Invoice Date
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv')?.addEventListener('click', () => {
            ...
            XLSX.writeFile(workbook, `pending-invoices-${new Date().toISOString().slice(0,10)}.xlsx`);
        });
