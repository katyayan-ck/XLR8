...
<section class="container-fluid">
    <h2>
        ...
        {{ request('retail_type', 'pending') === 'completed' ? 'Completed Retail' : 'Pending Retail' }}
        <small class="d-none d-md-inline">
            {{ request('retail_type', 'pending') === 'completed' ? '(Retailed Bookings)' : '(Awaiting Retail
            Processing)' }}
        </small>
    </h2>
</section>
        ...
        <div class="card">
            ...
            <div
                ...
                <h3 class="card-title mb-0 fw-bold text-black text-nowrap">
                    {{ request('retail_type', 'pending') === 'completed' ? 'Completed' : 'Pending' }} Retail Dashboard
                </h3>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv')?.addEventListener('click', () => {
            ...
            XLSX.utils.book_append_sheet(workbook, worksheet, 'Finance Retail');
            XLSX.writeFile(workbook, 'finance-retail-report-' + new Date().toISOString().slice(0,10) + '.xlsx');
        });
