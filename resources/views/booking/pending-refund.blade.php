...
<style>
    ...
    /* Center GROUP / parent headers – this is the main fix you need */
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportExcel')?.addEventListener('click', () => {
            ...
            doc.autoTable({
                ...
                startY: 50,
                styles: { fontSize: 8 },
                headStyles: { fillColor: [220, 53, 69] }, // red theme for refunds
            });
